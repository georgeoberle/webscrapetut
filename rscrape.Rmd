...
house_party_data %>%
  ...
  html_table() %>%
write.csv(house_party_data,file="data.csv")
...
<- html_session ("http://www.amphilsoc.org/mole/view?docId=ead/APS.Archives-ead.xml#d26860101e8658654068736")
#apseadelement<- html_table (apsead) %>%
